...
class RotationKinematicFactor
    : public gtsam::NoiseModelFactor5<gtsam::Pose3, gtsam::Pose3, gtsam::Pose3, gtsam::Pose3, gtsam::Point3> {
 private:
  typedef gtsam::NoiseModelFactor5<gtsam::Pose3, gtsam::Pose3, gtsam::Pose3, gtsam::Pose3, gtsam::Point3> Base;
 ...
 public:
   ...
   */
  RotationKinematicFactor(gtsam::Key PWtoBi, gtsam::Key PGitoBi, gtsam::Key PWtoBj, gtsam::Key PGjtoBj,
                          gtsam::Key tGtoBt_G, const gtsam::SharedNoiseModel& model);
   ...
   * */
  gtsam::Vector evaluateError(const gtsam::Pose3& PWtoBi, const gtsam::Pose3& PGitoBi,
                       const gtsam::Pose3& PWtoBj, const gtsam::Pose3& PGjtoBj,
                       const gtsam::Point3& tGtoBt_G,
   ...
   * - satisfies requirements of Testable
   * */
  using gtsam::NonlinearFactor::equals;  // To let compiler know we are not hiding.
...
//template <>
//struct gtsam::traits<RotationKinematicFactor>
  //  : public gtsam::Testable<RotationKinematicFactor> {};
}  // end namespace gtsam
