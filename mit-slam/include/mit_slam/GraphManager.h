 ...
 */
 ...
 // #include "mit_slam/BearingRangeFactorWithTransform.h"
  ...
  class GraphManager {
    public:
        ...
        struct Params {
          ...
          gtsam::noiseModel::Diagonal::shared_ptr blobpNM;
         ...
         */
         ...
         void InitChaserChain(const Eigen::Matrix4f &T_WC, const Eigen::Vector3f &v_WC, const Eigen::Vector3f &t_GC);
