...
/* ************************************************************************* */
InertiaRatiosManifoldFactor::InertiaRatiosManifoldFactor(
    const Key& J, const Key& h_ij, const Key& T_GiBi, const Key& T_GjBj,
    const Key& T_WBi, const Key& T_WBj, const SharedNoiseModel& model,
...
/* ************************************************************************* */
Vector InertiaRatiosManifoldFactor::evaluateError(
    const sph::InertiaRatios& J, const Vector3& h_ij, const Pose3& T_GiBi,
...
/* ************************************************************************* */
void InertiaRatiosManifoldFactor::print(
...
/* ************************************************************************* */
bool InertiaRatiosManifoldFactor::equals(
    const InertiaRatiosManifoldFactor& factor, double tol) const {
